...
**Theme:** Blue & White  
**Status:** All pages with basic structure implemented
...
4. ✅ `/apps/country/[code]` - Country Apps (US, IN, GB)
...
9. ✅ `/apps/[store]/[appId]/alerts` - Alerts
10. ✅ `/apps/[store]/[appId]/insights` - AI Insights
11. ✅ `/apps/[store]/[appId]/notes` - Notes
...
**Consistent Elements:**
- All pages use blue buttons (`bg-blue-600`, `hover:bg-blue-700`)
- White cards with gray borders
- Blue accents for links and highlights
...
- ✅ Navigation links
- ✅ Placeholder content where backend APIs are needed
